...
import styled, { ITheme } from "../../utils/styled";
...
class ShowHeroesPage extends React.Component<AllProps, IState> {
...
const Bullet = styled("div")`
  ...
  margin-right: 8px;
  border-radius: 50%;
  background-color: ${(props: Themed<IBulletProps, ITheme>) => props.theme.colors.attrs[props.attr]};
`;
